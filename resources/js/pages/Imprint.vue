...
<template>
  <Layout :head="t('imprint.title')" :link="imprint.url()" :description="t('imprint.subTitle')">
    <div class="container mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <main class="mt-8 prose dark:prose-invert max-w-none">
        <div class="not-prose rounded-lg border bg-card text-card-foreground p-6">
        ...
        <!-- <div class="mt-8 not-prose text-center">
          <img 
